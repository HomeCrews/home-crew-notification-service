# home-crew-notification-service

Sends notifications in response to events on Kafka.
...
|---|---|
| Port | 8086 |
| Route through the gateway | `/notifications/**` |
| Java package | `com.homecrew.notificationservice` |
| Maven artifact | `notificationservice` |
| Image | `mthanuj/homecrew-notification-service:dev` |
| Compose service | `notification-service` |
| Database | none, reads Kafka |
| Default branch | `dev` |
...
A push to `dev` builds the image and pushes two tags to Docker Hub:
    ...
    mthanuj/homecrew-notification-service:dev
    mthanuj/homecrew-notification-service:sha-<short>
